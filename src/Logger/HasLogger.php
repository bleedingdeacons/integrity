 ...
 *
 * This file is a local copy so the trait resolves via this plugin's own
 * autoloader with no cross-plugin dependency at class-load time.
 */
trait HasLogger
{
