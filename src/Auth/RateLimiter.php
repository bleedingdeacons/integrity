...
class RateLimiter
{
     ...
     */
    public static function checkLimit(int $apiKeyId, int $limit): array
    {
        global $wpdb;
        
        $tableName = $wpdb->prefix . 'integrity_rate_limits';
        $windowStart = self::getCurrentWindow();
     ...
     * @return void
     */
    public static function incrementCount(int $apiKeyId): void
    {
        global $wpdb;
     ...
     */
    private static function getCurrentWindow(): string
    {
     ...
     */
    public static function getHeaders(int $limit, int $remaining, int $reset): array
    {
        return [
